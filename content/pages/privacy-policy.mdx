...
description: Privacy policy for Catan Board Generator
created_at: 2026-03-22
---

## Introduction

Welcome to Catan Board Generator, an **online board generator tool** for Settlers of Catan. At Catan Board Generator, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using Catan Board Generator:

1. **Usage Details**
   - **What We Collect**: Information about how you use Catan Board Generator, including board generations, custom rule settings, and usage frequency.
   - **Purpose**: To analyze user engagement and improve our services.

2. **Device Information**
   - **What We Collect**: Data regarding the devices you use to access Catan Board Generator, such as device type, operating system, and browser type.
...
**Copyright Owner**: [catanboardgenerator.online](https://catanboardgenerator.online)
**Email**: [support@catanboardgenerator.online](mailto:support@catanboardgenerator.online)

By using Catan Board Generator, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
